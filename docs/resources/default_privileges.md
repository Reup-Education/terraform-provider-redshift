...
- **group** (String) The name of the group to which the specified default privileges are applied. Exactly one of `group`, `user`, or `role` must be set.
- **id** (String) The ID of this resource.
- **role** (String) The name of the role to which the specified default privileges are applied. Exactly one of `role`, `user`, or `group` must be set.
...
- **user** (String) The name of the user to which the specified default privileges are applied. Exactly one of `user`, `group`, or `role` must be set.
